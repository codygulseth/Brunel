...
Use one FastAPI application with Jinja2 templates, SQLAlchemy 2, Pydantic validation, and a local SQLite database. Keep queries in a small service layer and use dependency injection for database sessions.
